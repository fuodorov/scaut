...
ALL_HORIZONTAL_POSITION_BR_MONITORS = [
...
ALL_VERTICAL_POSITION_BR_MONITORS = [[name.replace("AvX", "AvY"), limits] for name, limits in ALL_HORIZONTAL_POSITION_BR_MONITORS]

ALL_HORIZONTAL_POSITION_MONITORS = ALL_HORIZONTAL_POSITION_LG_MONITORS + ALL_HORIZONTAL_POSITION_LA_MONITORS + ALL_HORIZONTAL_POSITION_TB_MONITORS + ALL_HORIZONTAL_POSITION_BR_MONITORS

ALL_VERTICAL_POSITION_MONITORS = ALL_VERTICAL_POSITION_LG_MONITORS + ALL_VERTICAL_POSITION_LA_MONITORS + ALL_VERTICAL_POSITION_TB_MONITORS + ALL_VERTICAL_POSITION_BR_MONITORS
