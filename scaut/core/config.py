...
SCAN_LEAST_SQUARES_FITTING_MAX_NFEV = os.environ.get("SCAN_LEAST_SQUARES_FITTING_MAX_NFEV", 10)

SCAN_LEAST_SQUARES_FITTING_MAX_STEPS = os.environ.get("SCAN_LEAST_SQUARES_FITTING_MAX_STEPS", 1)

SCAN_LEAST_SQUARES_FITTING_REL_DIFF_STEP = os.environ.get("SCAN_LEAST_SQUARES_FITTING_REL_DIFF_STEP", 0.1)
