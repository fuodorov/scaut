...
SCAN_LEAST_SQUARES_FITTING_METHOD = os.environ.get("SCAN_LEAST_SQUARES_FITTING_METHOD", "lm")

SCAN_LEAST_SQUARES_FITTING_MAX_NFEV = os.environ.get("SCAN_LEAST_SQUARES_FITTING_MAX_NFEV", 100)

SCAN_LEAST_SQUARES_FITTING_MAX_STEPS = os.environ.get("SCAN_LEAST_SQUARES_FITTING_MAX_STEPS", 10)
