...
SCAN_LEAST_SQUARES_FITTING_PENALTY = os.environ.get("SCAN_LEAST_SQUARES_FITTING_PENALTY", 10)

SCAN_LEAST_SQUARES_FITTING_METHOD = os.environ.get("SCAN_LEAST_SQUARES_FITTING_METHOD", "dogbox")

SCAN_LEAST_SQUARES_FITTING_MAX_NFEV = os.environ.get("SCAN_LEAST_SQUARES_FITTING_MAX_NFEV", 3)

SCAN_LEAST_SQUARES_FITTING_MAX_STEPS = os.environ.get("SCAN_LEAST_SQUARES_FITTING_MAX_STEPS", 3)

SCAN_LEAST_SQUARES_FITTING_REL_DIFF_STEP = os.environ.get("SCAN_LEAST_SQUARES_FITTING_REL_DIFF_STEP", 0.01)

SCAN_RESPONSE_MEASUREMENTS_NUM_SINGULAR_VALUES = os.environ.get("SCAN_RESPONSE_MEASUREMENTS_NUM_SINGULAR_VALUES", 10)
