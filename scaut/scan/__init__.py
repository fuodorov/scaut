...
@least_squares_fitting(targets={}, penalty=cfg.SCAN_LEAST_SQUARES_FITTING_PENALTY, method=cfg.SCAN_LEAST_SQUARES_FITTING_METHOD, max_nfev=cfg.SCAN_LEAST_SQUARES_FITTING_MAX_NFEV, max_steps=cfg.SCAN_LEAST_SQUARES_FITTING_MAX_STEPS, rel_diff_step=cfg.SCAN_LEAST_SQUARES_FITTING_REL_DIFF_STEP)
def fit(*args, **kwargs):
    return scan(*args, **kwargs)
