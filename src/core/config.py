...
SCAN_BAYESIAN_OPTIMIZATION_N_CALLS = os.environ.get("SCAN_BAYESIAN_OPTIMIZATION_N_CALLS", 100)
...
SCAN_RESPONSE_MEASUREMENTS_RCOND = os.environ.get("SCAN_RESPONSE_MEASUREMENTS_RCOND", 0.5)
